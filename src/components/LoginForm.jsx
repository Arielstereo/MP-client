  ...
  return (
    <div className='flex flex-col items-center justify-center h-full'>
      <form onSubmit={handleSubmitted} className='w-full max-w-xs'>
        ...
        <button type='submit' className='w-full px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>Ingresar</button>
      ...
      <p className='mt-4 text-sm text-gray-600'>No tienes una cuenta? <Link to='/register' className='text-blue-500 hover:underline'>Registrate!</Link></p>
    </div>
  )
}
